...
size_t ShuffleFindB(const std::map<size_t, size_t>& mapping, size_t num) {
  // we do not use cut-and-choose and set N = 1, so return the largest N for
  // T=2^4
  return 19;
